...
const Signup = () => {
  ...
  const handleSignup = (e: React.FormEvent) => {
    e.preventDefault();
    toast({ title: "Sign Up", description: "Firebase authentication will be connected soon." });
  };
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <Link to="/" className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="font-display text-2xl font-bold text-foreground">TravelMate</span>
          </Link>
          <h1 className="text-2xl font-bold text-foreground">Create your account</h1>
          <p className="text-muted-foreground mt-1">Start your travel adventure today</p>
        </div>

        <div className="bg-card rounded-2xl border shadow-card p-8 space-y-6">
          ...
          <Button variant="outline" className="w-full" size="lg" onClick={() => toast({ title: "Google Sign-Up", description: "Firebase Google auth will be connected." })}>
