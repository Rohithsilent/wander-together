...
const Login = () => {
  ...
  const handleForgotPassword = async () => {
    if (!email) {
      toast({ title: "Enter your email", description: "Please enter your email address first." });
      return;
    }
    try {
    ...
    <div className="min-h-screen relative flex items-center justify-center px-4 overflow-hidden">
      ...
      >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            >
              <button
                ...
                className="text-xs text-white/60 hover:text-white uppercase tracking-[0.2em] transition-all hover:underline"
              >
                Forgot password?
              </button>
            </motion.div>
            ...
            >
              <Button
                type="submit"
                className="w-full h-12 text-sm font-semibold uppercase tracking-[0.2em] text-white border border-white/20 rounded-full backdrop-blur-xl bg-white/5 hover:bg-white/15 transition-all duration-500 hover:scale-105 hover:border-white/40"
                disabled={loading}
              >
        ...
        >
          ...
          <Link to="/signup" className="text-white font-medium hover:underline transition-all hover:text-white/90">
            Sign up
          </Link>
        </motion.p>
      </motion.div>
