...
import { User, Camera, MapPin, Globe, DollarSign } from "lucide-react";
...
const Profile = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    age: "28",
    gender: "Male",
    bio: "Passionate traveler exploring Southeast Asia. Love adventure sports and local cuisine.",
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <div className="flex items-center gap-6 mb-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Member since 2026</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSave} className="bg-card rounded-2xl border shadow-card p-8 space-y-6">
            ...
            <Button type="submit" variant="hero" size="lg" className="w-full">Save Profile</Button>
          </form>
        </div>
      </main>
    </div>
